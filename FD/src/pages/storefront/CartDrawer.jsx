...
export default function CartDrawer({ isOpen, onClose }) {
  ...
  const handleClose = (e) => {
    ...
    if (typeof onClose === "function") {
      ...
      console.error(
        "CartDrawer is missing the onClose prop from StorefrontLayout!",
      );
    }
  };

  // 2. Handles all link clicks (clears drawer, then routes)
  const handleNavigate = (e, path) => {
    handleClose(e);
    navigate(path);
  };

  // 3. Handles adding/increasing items
  ...
  // 4. Handles decreasing/removing items
            ...
            <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-white">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-[12px] font-bold tracking-widest uppercase text-[#111827] mt-0.5">
                  Cart{" "}
                  <span className="bg-charcoal text-white text-[9px] px-1.5 py-0.5 rounded-full ml-1">
                    {totalQuantity || 0}
                  </span>
                </h2>
              </div>
                ...
                <div className="h-full flex flex-col items-center justify-center text-center space-y-6 pb-12">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-[14px] leading-relaxed max-w-[250px]">
                      Discover premium architectural assets and industrial
                      design objects.
                    </p>
                  </div>
                  <button
                    ...
                    return (
                      <li key={uniqueId} className="flex gap-6">
                        ...
                        <div
                          ...
                          onClick={(e) =>
                            handleNavigate(e, `/architecture/${uniqueId}`)
                          }
                        >
                          <img
                            src={
                        ...
                        <div className="flex flex-col flex-1 py-1 justify-between">
                          ...
                          <div className="flex items-end justify-between mt-4">
                            <div className="flex items-center border border-gray-200 h-8 rounded-sm">
                              ...
                              <button
                                onClick={(e) =>
                                  handleIncrease(e, item, uniqueId)
                                }
                                className="w-8 flex items-center justify-center text-gray-400 hover:text-[#111827] transition-colors cursor-pointer"
                              >
